...
For the case where both RNA and protein are single-stranded, we provide a simple script(6A_calculation.sh and DRPScore.sh) to use the flow from pdb files to scoring.
